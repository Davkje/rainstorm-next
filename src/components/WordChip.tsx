...
export default function WordChip({ word, parentId, onRemove, isOverlay }: WordChipProps) {
	...
	const baseClasses =
		"manipulation uppercase flex justify-center items-center rounded-lg text-rain-100 capitalize select-none transition-all";
	...
	const categoryClasses =
		"group relative gap-1 bg-rain-600/60 px-4 py-1 text-md sm:text-lg font-bold hover:bg-rain-600";
