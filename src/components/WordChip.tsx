...
export default function WordChip({ word, parentId, onRemove, isOverlay }: WordChipProps) {
	...
	const generatorClasses =
		"px-10 py-3 text-3xl bg-rain-600 font-bold hover:bg-rain-600 shadow-black-red shadow-[0_10px_24px_rgba(0,0,0,0.10)]";
	const categoryClasses =
		"group relative gap-1 bg-rain-600 px-4 py-1 text-lg sm:text-lg font-bold hover:bg-rain-600";
